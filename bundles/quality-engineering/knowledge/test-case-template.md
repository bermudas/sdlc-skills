...
# automated_spec:      # runner-managed — path to tests/TC-NNN.spec.ts after first clean PASS (enables cheap replay)
# codified_build:      # runner-managed — build the spec was generated against (staleness signal)
# visual_scenario:     # runner-managed — scenarios/TC-NNN.json + visual baselines, for cases with a visual surface
---
